...
func (r *AerospikeClusterReconciler) createStatefulSet(aeroCluster *aerospikev1alpha1.AerospikeCluster, namespacedName types.NamespacedName, rackState RackState) (*appsv1.StatefulSet, error) {
	...
	if rackState.Rack.ID != aerospikev1alpha1.DefaultRackID {
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					InitContainers: []corev1.Container{{
						Name:  aerospikev1alpha1.AerospikeServerInitContainerName,
					...
					Containers: []corev1.Container{{
						Name:            aerospikev1alpha1.AerospikeServerContainerName,
...
func (r *AerospikeClusterReconciler) deleteStatefulSet(aeroCluster *aerospikev1alpha1.AerospikeCluster, st *appsv1.StatefulSet) error {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) waitForStatefulSetToBeReady(st *appsv1.StatefulSet) error {
	// logger := pkglog.New("AerospikeCluster statefulset", types.NamespacedName{Name: st.Name, Namespace: st.Namespace})
	...
	for podIndex = 0; podIndex < *st.Spec.Replicas; podIndex++ {
		...
		if !isReady {
			...
			r.Log.Error(statusErr, "Statefulset Not ready", "err", statusErr)
			return statusErr
		}
	}
...
func (r *AerospikeClusterReconciler) getStatefulSet(aeroCluster *aerospikev1alpha1.AerospikeCluster, rackState RackState) (*appsv1.StatefulSet, error) {
...
func (r *AerospikeClusterReconciler) buildConfigMap(aeroCluster *aerospikev1alpha1.AerospikeCluster, namespacedName types.NamespacedName, rack aerospikev1alpha1.Rack) error {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) updateConfigMap(aeroCluster *aerospikev1alpha1.AerospikeCluster, namespacedName types.NamespacedName, rack aerospikev1alpha1.Rack) error {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) updateConfigMapPodList(aeroCluster *aerospikev1alpha1.AerospikeCluster, podNames []string) error {
...
func (r *AerospikeClusterReconciler) createHeadlessSvc(aeroCluster *aerospikev1alpha1.AerospikeCluster) error {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) createServiceForPod(aeroCluster *aerospikev1alpha1.AerospikeCluster, pName, pNamespace string) error {
	service := &corev1.Service{}
	...
	service = &corev1.Service{
		...
		Spec: corev1.ServiceSpec{
			...
			Ports: []corev1.ServicePort{
				{
					Name: "info",
					Port: aerospikev1alpha1.ServicePort,
				},
			},
	...
	if name := getServiceTLSName(aeroCluster); name != "" {
		service.Spec.Ports = append(service.Spec.Ports, corev1.ServicePort{
			Name: "tls",
			Port: aerospikev1alpha1.ServiceTLSPort,
		})
	}
	// Set AerospikeCluster instance as the owner and controller.
...
func (r *AerospikeClusterReconciler) getClusterPVCList(aeroCluster *aerospikev1alpha1.AerospikeCluster) ([]corev1.PersistentVolumeClaim, error) {
...
func (r *AerospikeClusterReconciler) getRackPVCList(aeroCluster *aerospikev1alpha1.AerospikeCluster, rackID int) ([]corev1.PersistentVolumeClaim, error) {
	// List the pvc for this aeroCluster's statefulset
	pvcList := &corev1.PersistentVolumeClaimList{}
...
func (r *AerospikeClusterReconciler) getPodsPVCList(aeroCluster *aerospikev1alpha1.AerospikeCluster, podNames []string, rackID int) ([]corev1.PersistentVolumeClaim, error) {
...
func (r *AerospikeClusterReconciler) getRackPodList(aeroCluster *aerospikev1alpha1.AerospikeCluster, rackID int) (*corev1.PodList, error) {
...
func (r *AerospikeClusterReconciler) getOrderedRackPodList(aeroCluster *aerospikev1alpha1.AerospikeCluster, rackID int) ([]corev1.Pod, error) {
...
func (r *AerospikeClusterReconciler) getClusterPodList(aeroCluster *aerospikev1alpha1.AerospikeCluster) (*corev1.PodList, error) {
	// List the pods for this aeroCluster's statefulset
	podList := &corev1.PodList{}
	labelSelector := labels.SelectorFromSet(utils.LabelsForAerospikeCluster(aeroCluster.Name))
	listOps := &client.ListOptions{Namespace: aeroCluster.Namespace, LabelSelector: labelSelector}
...
func (r *AerospikeClusterReconciler) getOrderedClusterPodList(aeroCluster *aerospikev1alpha1.AerospikeCluster) ([]corev1.Pod, error) {
...
func (r *AerospikeClusterReconciler) getClusterStatefulSets(aeroCluster *aerospikev1alpha1.AerospikeCluster) (*appsv1.StatefulSetList, error) {
	// List the pods for this aeroCluster's statefulset
...
func (r *AerospikeClusterReconciler) getClusterServerPool(aeroCluster *aerospikev1alpha1.AerospikeCluster) *x509.CertPool {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) getClientCertificate(aeroCluster *aerospikev1alpha1.AerospikeCluster) (*tls.Certificate, error) {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) isAeroClusterUpgradeNeeded(aeroCluster *aerospikev1alpha1.AerospikeCluster, rackID int) (bool, error) {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) isAnyPodInFailedState(aeroCluster *aerospikev1alpha1.AerospikeCluster, podList []corev1.Pod) bool {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) getPasswordProvider(aeroCluster *aerospikev1alpha1.AerospikeCluster) FromSecretPasswordProvider {
	return FromSecretPasswordProvider{client: &r.Client, namespace: aeroCluster.Namespace}
}

func (r *AerospikeClusterReconciler) getClientPolicy(aeroCluster *aerospikev1alpha1.AerospikeCluster) *as.ClientPolicy {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) updateStatefulSetStorage(aeroCluster *aerospikev1alpha1.AerospikeCluster, st *appsv1.StatefulSet, rackState RackState) error {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) updateStatefulSetAffinity(aeroCluster *aerospikev1alpha1.AerospikeCluster, st *appsv1.StatefulSet, labels map[string]string, rackState RackState) {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func (r *AerospikeClusterReconciler) updateStatefulSetSecretInfo(aeroCluster *aerospikev1alpha1.AerospikeCluster, st *appsv1.StatefulSet) {
	// logger := pkglog.New("AerospikeCluster", utils.ClusterNamespacedName(aeroCluster))
...
func getAeroClusterContainerPort(multiPodPerHost bool) []corev1.ContainerPort {
	...
	if multiPodPerHost {
		...
		ports = []corev1.ContainerPort{
			{
				Name:          aerospikev1alpha1.ServicePortName,
				ContainerPort: aerospikev1alpha1.ServicePort,
			},
			{
				Name:          aerospikev1alpha1.ServiceTLSPortName,
				ContainerPort: aerospikev1alpha1.ServiceTLSPort,
			},
			{
				Name:          aerospikev1alpha1.HeartbeatPortName,
				ContainerPort: aerospikev1alpha1.HeartbeatPort,
			},
			{
				Name:          aerospikev1alpha1.HeartbeatTLSPortName,
				ContainerPort: aerospikev1alpha1.HeartbeatTLSPort,
			},
			{
				Name:          aerospikev1alpha1.FabricPortName,
				ContainerPort: aerospikev1alpha1.FabricPort,
			},
			{
				Name:          aerospikev1alpha1.FabricTLSPortName,
				ContainerPort: aerospikev1alpha1.FabricPort,
			},
			{
				Name:          aerospikev1alpha1.InfoPortName,
				ContainerPort: aerospikev1alpha1.InfoPort,
			},
		}
	} else {
		...
		ports = []corev1.ContainerPort{
			{
				Name:          aerospikev1alpha1.ServicePortName,
				ContainerPort: aerospikev1alpha1.ServicePort,
				HostPort:      aerospikev1alpha1.ServicePort,
			},
			{
				Name:          aerospikev1alpha1.ServiceTLSPortName,
				ContainerPort: aerospikev1alpha1.ServiceTLSPort,
				HostPort:      aerospikev1alpha1.ServiceTLSPort,
			},
			{
				Name:          aerospikev1alpha1.HeartbeatPortName,
				ContainerPort: aerospikev1alpha1.HeartbeatPort,
			...
			},
			{
				Name:          aerospikev1alpha1.InfoPortName,
				ContainerPort: aerospikev1alpha1.InfoPort,
				HostPort:      aerospikev1alpha1.InfoPort,
			},
		}
	}
	return ports
