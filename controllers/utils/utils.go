...
func IsImageEqual(image1 string, image2 string) bool {
	...
	desiredRegistry, desiredName, desiredVersion := aerospikev1alpha1.ParseDockerImageTag(desiredImageWithVersion)
	actualRegistry, actualName, actualVersion := aerospikev1alpha1.ParseDockerImageTag(actualImageWithVersion)
...
func GetImageVersion(tag string) (string, error) {
	_, _, version := aerospikev1alpha1.ParseDockerImageTag(tag)
...
func GetDesiredImage(aeroCluster *aerospikev1alpha1.AerospikeCluster, containerName string) (string, error) {
	if containerName == aerospikev1alpha1.AerospikeServerContainerName {
